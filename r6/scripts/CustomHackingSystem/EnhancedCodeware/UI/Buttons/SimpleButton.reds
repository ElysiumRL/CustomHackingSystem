...
public class SimpleButton extends CustomButton {
	...
	protected func CreateWidgets() -> Void {
		...
		bg.SetTintColor(MainColors.PanelBlue());
		bg.SetTintColor(MainColors.Red());
		...
		fill.SetTintColor(MainColors.Black());
		fill.Reparent(root);
		...
		label.SetTintColor(MainColors.ActiveBlue());
	...
	protected func CreateHackSquareButton() -> Void
	{
		let root: ref<inkCanvas> = new inkCanvas();
		root.SetName(n"button");
		root.SetSize(400.0, 100.0);
		...
		let bg: ref<inkImage> = new inkImage();
		bg.SetName(n"bg");
		bg.SetAtlasResource(r"base\\gameplay\\gui\\fullscreen\\hacking_minigame\\atlas_minigame.inkatlas");
		bg.SetTintColor(MainColors.ActiveRed());
		bg.SetOpacity(0.8);
		bg.SetAnchor(inkEAnchor.Fill);
		bg.SetNineSliceScale(true);
		bg.SetNineSliceGrid(new inkMargin(0.0, 0.0, 10.0, 0.0));
		...
		let fill: ref<inkImage> = new inkImage();
		fill.SetName(n"fill");
		fill.SetAtlasResource(r"base\\gameplay\\gui\\fullscreen\\hacking_minigame\\atlas_minigame.inkatlas");
		fill.SetOpacity(1.0);
		fill.SetTintColor(MainColors.Red());
		fill.SetAnchor(inkEAnchor.Fill);
		fill.SetNineSliceScale(true);
		fill.SetNineSliceGrid(new inkMargin(0.0, 0.0, 10.0, 0.0));
		fill.Reparent(root);
		...
		let frame: ref<inkImage> = new inkImage();
		frame.SetName(n"frame");
		frame.SetAtlasResource(r"base\\gameplay\\gui\\fullscreen\\hacking_minigame\\atlas_minigame.inkatlas");
		frame.SetOpacity(1.0);
		frame.SetAnchor(inkEAnchor.Fill);
		frame.SetNineSliceScale(true);
		frame.SetNineSliceGrid(new inkMargin(0.0, 0.0, 10.0, 0.0));
	...
	protected func CreateAnimations() -> Void {
		...
		hoverFillColorAnim.SetStartColor(MainColors.PanelDarkBlue());
		hoverFillColorAnim.SetEndColor(MainColors.Blue());
		...
		hoverFrameColorAnim.SetStartColor(MainColors.ActiveRed());
		hoverFrameColorAnim.SetEndColor(MainColors.ActiveBlue());
