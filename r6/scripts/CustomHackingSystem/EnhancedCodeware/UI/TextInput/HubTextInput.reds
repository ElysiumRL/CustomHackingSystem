...
public class HubTextInput extends TextInput {
	...
	protected func CreateWidgets() -> Void {
		...
		fill.SetTintColor(MainColors.ActiveBlue());
		...
		frame.SetTintColor(MainColors.ActiveRed());
		...
		hover.SetTintColor(MainColors.Red());
		...
		focus.SetTintColor(MainColors.ActiveBlue());
