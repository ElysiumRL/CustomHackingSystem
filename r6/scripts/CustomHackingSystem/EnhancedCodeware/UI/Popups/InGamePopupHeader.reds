...
public class InGamePopupHeader extends inkCustomController {
	...
	protected cb func OnCreate() -> Void {
		...
		bgr.SetOpacity(0.07);
		bgr.SetTintColor(MainColors.PanelRed());
		...
		bracketBg.SetTintColor(MainColors.PanelBlue());
		...
		bracketBgr.SetTintColor(MainColors.Red());
		...
		bracketFg.SetTintColor(MainColors.Red());
		...
		title.SetTintColor(MainColors.ActiveBlue());
		...
		fluffTextR.SetTintColor(MainColors.Red());
		...
		fluffTextL.SetTintColor(MainColors.Red());
