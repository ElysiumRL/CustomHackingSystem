...
public class InkObjectTickManager extends ScriptableSystem
{
    ...
    public let objectsRegistered: array<wref<inkCustomController>>;

    //Registers the object to the list of controllers to update
    //Make sure you implemented inkCustomController::ShouldRegisterForTickEvent 
    //and set the return value as true in order to register the target to the tick manager
    public func RegisterObject(target: wref<inkCustomController>) -> Bool
    {
    ...
    public func UnregisterObject(target: wref<inkCustomController>) -> Bool
    {
